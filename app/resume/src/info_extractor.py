...
class InfoExtractor:
    ...
    def extractFromText(self, doc, text, filename):
        ...
        with open('app/resume/res_data.txt', 'w') as f:

            print("Name: %s" % name, file=f)
            print("Email: %s" % email, file=f)
            print("Number: %s" % number, file=f)
            print("City/Country: %s" % city, file=f)
            print("\nWork Experience:", file=f)
            print(totalWorkExperience, file=f)
            for w in workAndEducation["Work"]:
                print(" - " + w, file=f)
            print("\nEducation:", file=f)
            print(totalEducationExperience, file=f)
            for e in workAndEducation["Education"]:
                print(" - " + e, file=f)
            print("\nSkills:", file=f)
            print(allSkills, file=f)
